...
if ('add' == $func || 'edit' == $func) {
    ...
    $previewContent = '
    <div id="extra-styles-preview-wrapper" style="
        padding: 20px; 
        border-radius: 4px; 
        background-image: 
        ...
        <div id="preview-box" style="padding: 30px; min-height: 200px; border-radius: 0; transition: all 0.3s ease; background: rgba(245, 245, 245, 0.9); color: #333;">
